...
class TitulkyProvider(Provider, ProviderSubtitleArchiveMixin):
    ...
    def get_request(self, url, ref=server_url, allow_redirects=False, _recursion=0):
        ...
        if res.is_redirect:
            ...
            if "omezené" in error_message.lower():
            ...
            raise ProviderError(f"Got redirected from {url} to an error page with message: \"{error_message}\"");
